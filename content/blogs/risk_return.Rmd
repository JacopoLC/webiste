...
draft: false
image: static\img\blogs\spices.jpg # save picture in \static\img\blogs. Acceptable formats= jpg, jpeg, or png . Your iPhone pics wont work
...
```{r, tickers_from_wikipedia, class.source="watch-out", class.output="watch-out"}
...
```{r get_price_data, message=FALSE, warning=FALSE, cache=TRUE, class.source="watch-out", class.output="watch-out"}
...
```{r calculate_returns, message=FALSE, warning=FALSE, cache=TRUE, class.source="watch-out", class.output="watch-out"}
...
```{r, class.source="bg-success", class.source="watch-out", class.output="watch-out"}
...
```{r, risk_return, echo=FALSE, class.source="watch-out", class.output="watch-out"}
