...
```{r load-libraries, warning=FALSE, message=FALSE, echo=FALSE, class.source="watch.out"}
...
```{r, tickers_from_wikipedia, class.source="watch.out"}
...
```{r calculate_returns, message=FALSE, warning=FALSE, cache=TRUE, class.source="watch.out"}
...
```{r, class.source="bg-success", class.source="watch.out"}
...
```{r, risk_return, echo=FALSE, class.source="watch.out"}
